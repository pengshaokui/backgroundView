...
class DecorationTextview : TextView {
    ...
    fun initAttrs(context: Context, attrs: AttributeSet) {
        ...
        var pressed_text_color = attrsArry.getColor(
            R.styleable.decorationAttrStyle_decoration_pressed_text_color,
            -2
        )
        var normal_text_color = attrsArry.getColor(
            R.styleable.decorationAttrStyle_decoration_normal_text_color,
            -2
        )
        ...
        if (pressed_text_color != -2 && normal_text_color != -2) {
